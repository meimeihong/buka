<template>
	...
	<div id="CategoryList">
		...
		<div class="container" v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="200">
			<div class="manga-item" v-for='(items,index) in CategoryList' :key='index' @click="setid(items)">
				<a href="javascript:0">
